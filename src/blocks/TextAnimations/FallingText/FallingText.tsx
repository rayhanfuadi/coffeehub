  ...
  useEffect(() => {
    ...
    const newHTML = words
      .map((word) => {
        ...
        return `<span
          class="inline-block m-[2px] px-[24px] py-[16px] rounded-full border-[1px] border-p950 w-fit hover:font-medium text-p800 hover:text-p950 text-[16px] select-none ${isHighlighted ? "" : ""
          }"
        >
          ${word}
        </span>`;
