...
const BlogCard = (props: BlogCardProps) => {
    ...
    return (
        <div className='grid h-full rounded-[24px] bg-white overflow-hidden drop-shadow-[0_2px_16px_rgba(124,49,11,0.2)] cursor-pointer hover:border  hover:border-[2px] hover:border-p600'>
            ...
            <div className="grid content-between h-full px-5 pt-[14px] pb-[20px]">
                <h3 className='text-[18px] text-p950 mb-6'>{tittle}</h3>
