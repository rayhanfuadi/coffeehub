...
const Footer = () => {
    return (
        <div className='xl:flex lg:grid grid xl:gap-[60px] lg:gap-[60px] gap-[48px] justify-between xl:px-[60px] xl:py-[100px] lg:px-[30px] lg:py-[60px] px-[16px] py-[42px] bg-p50'>
            <div className="grid lg:grid-cols-8 xl:gap-[32px] lg:gap-[24px] gap-[24px]">
            ...
            <div className="grid gap-[32px]">
                ...
                <div className="flex gap-[80px] text-[14px] text-p900">
                    ...
                    <div className="grid gap-[16px] w-[100px]">
                        ...
                        <p className='xl:hidden lg:hidden block hover:underline hover:underline-offset-4'>Contact</p>
                    </div>
                    <div className="xl:grid lg:grid hidden gap-[16px] w-[100px]">
