...
const BigBlogCard = (props: BlogCardProps) => {
    ...
    return (
        <div className='relative group xl:h-full lg:h-full h-[400px] overflow-hidden rounded-[24px] cursor-pointer hover:border-[2px] hover:border-p600'>
            <Image className='w-full h-full object-cover' src={img} alt="logo" width={1000} height={1000} />
